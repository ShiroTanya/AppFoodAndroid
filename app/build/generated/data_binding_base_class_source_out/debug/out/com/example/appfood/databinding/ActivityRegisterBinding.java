...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull LinearLayout rootView, @NonNull Button btnRegister,
      ...
      @NonNull EditText etPasswordConfirm, @NonNull ImageView imageView,
      @NonNull TextView textView2, @NonNull TextView tvStatus) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((LinearLayout) rootView, btnRegister, etEmail, etName,
          etPassword, etPasswordConfirm, imageView, textView2, tvStatus);
    }
