...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull LinearLayout rootView, @NonNull Spinner spinnerMap) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.spinnerMap;
      Spinner spinnerMap = ViewBindings.findChildViewById(rootView, id);
      if (spinnerMap == null) {
        break missingId;
      }

      return new ActivityMapBinding((LinearLayout) rootView, spinnerMap);
    }
